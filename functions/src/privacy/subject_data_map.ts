...
export const SUBJECT_DATA_MAP: SubjectDataEntry[] = [
  ...
  },
  {
    ...
    piiFields: ["persons[].name", "persons[].email", "persons[].billingAddress", "notes", "firebaseUid", "cancellationReason", "cancelledBy"],
  ...
  {
    collection: "bills",
    piiFields: ["userId", "referenceNumber (person-linkable)", "storagePath", "cancellationReason", "correctionReason", "cancelledBy"],
