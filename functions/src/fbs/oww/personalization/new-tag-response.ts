...
export class NewTagResponse implements flatbuffers.IUnpackableObject<NewTagResponseT> {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):NewTagResponse {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsNewTagResponse(bb:flatbuffers.ByteBuffer, obj?:NewTagResponse):NewTagResponse {
  return (obj || new NewTagResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsNewTagResponse(bb:flatbuffers.ByteBuffer, obj?:NewTagResponse):NewTagResponse {
...
static startNewTagResponse(builder:flatbuffers.Builder) {
...
static endNewTagResponse(builder:flatbuffers.Builder):flatbuffers.Offset {
...
static deserialize(buffer: Uint8Array):NewTagResponse {
  return NewTagResponse.getRootAsNewTagResponse(new flatbuffers.ByteBuffer(buffer))
}

unpack(): NewTagResponseT {
  return new NewTagResponseT(
...
unpackTo(_o: NewTagResponseT): void {
...
export class NewTagResponseT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  NewTagResponse.startNewTagResponse(builder);
  NewTagResponse.addApplicationKey(builder, (this.applicationKey !== null ? this.applicationKey!.pack(builder) : 0));
  NewTagResponse.addAuthorizationKey(builder, (this.authorizationKey !== null ? this.authorizationKey!.pack(builder) : 0));
  NewTagResponse.addReserved1Key(builder, (this.reserved1Key !== null ? this.reserved1Key!.pack(builder) : 0));
  NewTagResponse.addReserved2Key(builder, (this.reserved2Key !== null ? this.reserved2Key!.pack(builder) : 0));

  return NewTagResponse.endNewTagResponse(builder);
}
}
