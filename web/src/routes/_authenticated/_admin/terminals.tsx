  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const resp = await fetch(
        `${import.meta.env.DEV ? `http://127.0.0.1:5001/${import.meta.env.VITE_FIREBASE_PROJECT_ID}/${import.meta.env.VITE_FUNCTIONS_REGION}` : ""}/admin/particle/devices`,
        {
      ...
      for (const device of newDevices) {
        await fetch(
          `${import.meta.env.DEV ? `http://127.0.0.1:5001/${import.meta.env.VITE_FIREBASE_PROJECT_ID}/${import.meta.env.VITE_FUNCTIONS_REGION}` : ""}/admin/particle/import-device`,
          {
            method: "POST",
            headers: {
