...
#ifndef FLATBUFFERS_GENERATED_LEDGERTERMINALCONFIG_OWW_H_
#define FLATBUFFERS_GENERATED_LEDGERTERMINALCONFIG_OWW_H_
...
template<> struct MachineControlTraits<oww::MachineControlRelais> {
...
template<> struct MachineControlUnionTraits<oww::MachineControlRelaisT> {
  static const MachineControl enum_value = MachineControl::relais;
};
...
struct MachineControlUnion {
  ...
  oww::MachineControlRelaisT *Asrelais() {
    return type == MachineControl::relais ?
      reinterpret_cast<oww::MachineControlRelaisT *>(value) : nullptr;
  }
  const oww::MachineControlRelaisT *Asrelais() const {
    return type == MachineControl::relais ?
      reinterpret_cast<const oww::MachineControlRelaisT *>(value) : nullptr;
  }
};
...
struct MachineT : public ::flatbuffers::NativeTable {
  ...
  oww::MachineControlUnion control{};
};
...
struct Machine FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  oww::MachineControl control_type() const {
    return static_cast<oww::MachineControl>(GetField<uint8_t>(VT_CONTROL_TYPE, 0));
  }
  const void *control() const {
    return GetPointer<const void *>(VT_CONTROL);
  }
  template<typename T> const T *control_as() const;
  const oww::MachineControlRelais *control_as_relais() const {
    return control_type() == oww::MachineControl::relais ? static_cast<const oww::MachineControlRelais *>(control()) : nullptr;
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const oww::MachineControlRelais *Machine::control_as<oww::MachineControlRelais>() const {
...
struct MachineBuilder {
  ...
  void add_control_type(oww::MachineControl control_type) {
...
inline ::flatbuffers::Offset<Machine> CreateMachine(
    ...
    oww::MachineControl control_type = oww::MachineControl::NONE,
...
struct DeviceConfigT : public ::flatbuffers::NativeTable {
  ...
  oww::HwRevision hw_revision = oww::HwRevision::Unspecified;
  std::vector<std::unique_ptr<oww::MachineT>> machines{};
...
struct DeviceConfig FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  oww::HwRevision hw_revision() const {
    return static_cast<oww::HwRevision>(GetField<int8_t>(VT_HW_REVISION, 0));
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<oww::Machine>> *machines() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<oww::Machine>> *>(VT_MACHINES);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct DeviceConfigBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_hw_revision(oww::HwRevision hw_revision) {
    fbb_.AddElement<int8_t>(DeviceConfig::VT_HW_REVISION, static_cast<int8_t>(hw_revision), 0);
  }
  void add_machines(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<oww::Machine>>> machines) {
...
inline ::flatbuffers::Offset<DeviceConfig> CreateDeviceConfig(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    oww::HwRevision hw_revision = oww::HwRevision::Unspecified,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<oww::Machine>>> machines = 0) {
...
inline ::flatbuffers::Offset<DeviceConfig> CreateDeviceConfigDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    oww::HwRevision hw_revision = oww::HwRevision::Unspecified,
    const std::vector<::flatbuffers::Offset<oww::Machine>> *machines = nullptr) {
  auto machines__ = machines ? _fbb.CreateVector<::flatbuffers::Offset<oww::Machine>>(*machines) : 0;
  return oww::CreateDeviceConfig(
      _fbb,
      hw_revision,
      machines__);
}
...
inline ::flatbuffers::Offset<MachineControlRelais> CreateMachineControlRelais(::flatbuffers::FlatBufferBuilder &_fbb, const MachineControlRelaisT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return oww::CreateMachineControlRelais(
      _fbb);
}
...
inline void Machine::UnPackTo(MachineT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = control(); if (_e) _o->control.value = oww::MachineControlUnion::UnPack(_e, control_type(), _resolver); }
}
...
inline DeviceConfigT::DeviceConfigT(const DeviceConfigT &o)
  ...
  for (const auto &machines_ : o.machines) { machines.emplace_back((machines_) ? new oww::MachineT(*machines_) : nullptr); }
}
...
inline void DeviceConfig::UnPackTo(DeviceConfigT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = machines(); if (_e) { _o->machines.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->machines[_i]) { _e->Get(_i)->UnPackTo(_o->machines[_i].get(), _resolver); } else { _o->machines[_i] = std::unique_ptr<oww::MachineT>(_e->Get(_i)->UnPack(_resolver)); } } } else { _o->machines.resize(0); } }
}
...
inline ::flatbuffers::Offset<DeviceConfig> CreateDeviceConfig(::flatbuffers::FlatBufferBuilder &_fbb, const DeviceConfigT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _machines = _o->machines.size() ? _fbb.CreateVector<::flatbuffers::Offset<oww::Machine>> (_o->machines.size(), [](size_t i, _VectorArgs *__va) { return CreateMachine(*__va->__fbb, __va->__o->machines[i].get(), __va->__rehasher); }, &_va ) : 0;
  return oww::CreateDeviceConfig(
      _fbb,
      _hw_revision,
      _machines);
...
inline bool VerifyMachineControl(::flatbuffers::Verifier &verifier, const void *obj, MachineControl type) {
  switch (type) {
    ...
    case MachineControl::relais: {
      auto ptr = reinterpret_cast<const oww::MachineControlRelais *>(obj);
...
inline ::flatbuffers::Offset<void> MachineControlUnion::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const ::flatbuffers::rehasher_function_t *_rehasher) const {
  ...
  switch (type) {
    case MachineControl::relais: {
      auto ptr = reinterpret_cast<const oww::MachineControlRelaisT *>(value);
...
inline MachineControlUnion::MachineControlUnion(const MachineControlUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case MachineControl::relais: {
      value = new oww::MachineControlRelaisT(*reinterpret_cast<oww::MachineControlRelaisT *>(u.value));
      break;
    }
    default:
      break;
...
inline void MachineControlUnion::Reset() {
  switch (type) {
    case MachineControl::relais: {
      auto ptr = reinterpret_cast<oww::MachineControlRelaisT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
#endif  // FLATBUFFERS_GENERATED_LEDGERTERMINALCONFIG_OWW_H_
