...
#ifndef FLATBUFFERS_GENERATED_TOKENSESSION_FBS_H_
#define FLATBUFFERS_GENERATED_TOKENSESSION_FBS_H_
...
template<> struct StartSessionResultTraits<fbs::TokenSession> {
  static const StartSessionResult enum_value = StartSessionResult::TokenSession;
};

template<> struct StartSessionResultTraits<fbs::AuthRequired> {
  static const StartSessionResult enum_value = StartSessionResult::AuthRequired;
};

template<> struct StartSessionResultTraits<fbs::Rejected> {
...
template<> struct StartSessionResultUnionTraits<fbs::TokenSessionT> {
  static const StartSessionResult enum_value = StartSessionResult::TokenSession;
};

template<> struct StartSessionResultUnionTraits<fbs::AuthRequiredT> {
  static const StartSessionResult enum_value = StartSessionResult::AuthRequired;
};

template<> struct StartSessionResultUnionTraits<fbs::RejectedT> {
  static const StartSessionResult enum_value = StartSessionResult::Rejected;
};
...
struct StartSessionResultUnion {
  ...
  fbs::TokenSessionT *AsTokenSession() {
    return type == StartSessionResult::TokenSession ?
      reinterpret_cast<fbs::TokenSessionT *>(value) : nullptr;
  }
  const fbs::TokenSessionT *AsTokenSession() const {
    return type == StartSessionResult::TokenSession ?
      reinterpret_cast<const fbs::TokenSessionT *>(value) : nullptr;
  }
  fbs::AuthRequiredT *AsAuthRequired() {
    return type == StartSessionResult::AuthRequired ?
      reinterpret_cast<fbs::AuthRequiredT *>(value) : nullptr;
  }
  const fbs::AuthRequiredT *AsAuthRequired() const {
    return type == StartSessionResult::AuthRequired ?
      reinterpret_cast<const fbs::AuthRequiredT *>(value) : nullptr;
  }
  fbs::RejectedT *AsRejected() {
    return type == StartSessionResult::Rejected ?
      reinterpret_cast<fbs::RejectedT *>(value) : nullptr;
  }
  const fbs::RejectedT *AsRejected() const {
    return type == StartSessionResult::Rejected ?
      reinterpret_cast<const fbs::RejectedT *>(value) : nullptr;
  }
};
...
template<> struct CompleteAuthenticationResultTraits<fbs::TokenSession> {
  static const CompleteAuthenticationResult enum_value = CompleteAuthenticationResult::TokenSession;
};

template<> struct CompleteAuthenticationResultTraits<fbs::Rejected> {
...
template<> struct CompleteAuthenticationResultUnionTraits<fbs::TokenSessionT> {
  static const CompleteAuthenticationResult enum_value = CompleteAuthenticationResult::TokenSession;
};

template<> struct CompleteAuthenticationResultUnionTraits<fbs::RejectedT> {
  static const CompleteAuthenticationResult enum_value = CompleteAuthenticationResult::Rejected;
};
...
struct StartSessionResponseT : public ::flatbuffers::NativeTable {
  ...
  fbs::StartSessionResultUnion result{};
};
...
struct StartSessionResponse FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  fbs::StartSessionResult result_type() const {
    return static_cast<fbs::StartSessionResult>(GetField<uint8_t>(VT_RESULT_TYPE, 0));
  }
  const void *result() const {
    return GetPointer<const void *>(VT_RESULT);
  }
  template<typename T> const T *result_as() const;
  const fbs::TokenSession *result_as_TokenSession() const {
    return result_type() == fbs::StartSessionResult::TokenSession ? static_cast<const fbs::TokenSession *>(result()) : nullptr;
  }
  const fbs::AuthRequired *result_as_AuthRequired() const {
    return result_type() == fbs::StartSessionResult::AuthRequired ? static_cast<const fbs::AuthRequired *>(result()) : nullptr;
  }
  const fbs::Rejected *result_as_Rejected() const {
    return result_type() == fbs::StartSessionResult::Rejected ? static_cast<const fbs::Rejected *>(result()) : nullptr;
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const fbs::TokenSession *StartSessionResponse::result_as<fbs::TokenSession>() const {
  return result_as_TokenSession();
}

template<> inline const fbs::AuthRequired *StartSessionResponse::result_as<fbs::AuthRequired>() const {
  return result_as_AuthRequired();
}

template<> inline const fbs::Rejected *StartSessionResponse::result_as<fbs::Rejected>() const {
...
struct StartSessionResponseBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_result_type(fbs::StartSessionResult result_type) {
...
inline ::flatbuffers::Offset<StartSessionResponse> CreateStartSessionResponse(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    fbs::StartSessionResult result_type = fbs::StartSessionResult::NONE,
...
inline ::flatbuffers::Offset<AuthenticateNewSessionRequest> CreateAuthenticateNewSessionRequestDirect(
  ...
  return fbs::CreateAuthenticateNewSessionRequest(
      _fbb,
      token_id,
      ntag_challenge__);
}
...
inline ::flatbuffers::Offset<AuthenticateNewSessionResponse> CreateAuthenticateNewSessionResponseDirect(
  ...
  return fbs::CreateAuthenticateNewSessionResponse(
      _fbb,
      session_id__,
      cloud_challenge__);
}
...
inline ::flatbuffers::Offset<CompleteAuthenticationRequest> CreateCompleteAuthenticationRequestDirect(
  ...
  return fbs::CreateCompleteAuthenticationRequest(
      _fbb,
      session_id__,
...
struct CompleteAuthenticationResponseT : public ::flatbuffers::NativeTable {
  ...
  fbs::CompleteAuthenticationResultUnion result{};
};
...
struct CompleteAuthenticationResponse FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  fbs::CompleteAuthenticationResult result_type() const {
    return static_cast<fbs::CompleteAuthenticationResult>(GetField<uint8_t>(VT_RESULT_TYPE, 0));
  }
  const void *result() const {
    return GetPointer<const void *>(VT_RESULT);
  }
  template<typename T> const T *result_as() const;
  const fbs::TokenSession *result_as_TokenSession() const {
    return result_type() == fbs::CompleteAuthenticationResult::TokenSession ? static_cast<const fbs::TokenSession *>(result()) : nullptr;
  }
  const fbs::Rejected *result_as_Rejected() const {
    return result_type() == fbs::CompleteAuthenticationResult::Rejected ? static_cast<const fbs::Rejected *>(result()) : nullptr;
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_RESULT_TYPE, 1) &&
...
template<> inline const fbs::TokenSession *CompleteAuthenticationResponse::result_as<fbs::TokenSession>() const {
  return result_as_TokenSession();
}

template<> inline const fbs::Rejected *CompleteAuthenticationResponse::result_as<fbs::Rejected>() const {
  return result_as_Rejected();
}
...
struct CompleteAuthenticationResponseBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_result_type(fbs::CompleteAuthenticationResult result_type) {
...
inline ::flatbuffers::Offset<CompleteAuthenticationResponse> CreateCompleteAuthenticationResponse(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    fbs::CompleteAuthenticationResult result_type = fbs::CompleteAuthenticationResult::NONE,
    ::flatbuffers::Offset<void> result = 0) {
...
struct UploadUsageRequestT : public ::flatbuffers::NativeTable {
  ...
  std::unique_ptr<fbs::MachineUsageHistoryT> history{};
...
struct UploadUsageRequest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const fbs::MachineUsageHistory *history() const {
    return GetPointer<const fbs::MachineUsageHistory *>(VT_HISTORY);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct UploadUsageRequestBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_history(::flatbuffers::Offset<fbs::MachineUsageHistory> history) {
...
inline ::flatbuffers::Offset<UploadUsageRequest> CreateUploadUsageRequest(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<fbs::MachineUsageHistory> history = 0) {
...
inline ::flatbuffers::Offset<StartSessionRequest> CreateStartSessionRequest(::flatbuffers::FlatBufferBuilder &_fbb, const StartSessionRequestT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _token_id = _o->token_id ? _o->token_id.get() : nullptr;
  return fbs::CreateStartSessionRequest(
      _fbb,
      _token_id);
}
...
inline void StartSessionResponse::UnPackTo(StartSessionResponseT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = result(); if (_e) _o->result.value = fbs::StartSessionResultUnion::UnPack(_e, result_type(), _resolver); }
}
...
inline ::flatbuffers::Offset<StartSessionResponse> CreateStartSessionResponse(::flatbuffers::FlatBufferBuilder &_fbb, const StartSessionResponseT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return fbs::CreateStartSessionResponse(
      _fbb,
      _result_type,
      _result);
}
...
inline void CompleteAuthenticationResponse::UnPackTo(CompleteAuthenticationResponseT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = result_type(); _o->result.type = _e; }
  { auto _e = result(); if (_e) _o->result.value = fbs::CompleteAuthenticationResultUnion::UnPack(_e, result_type(), _resolver); }
}
...
inline ::flatbuffers::Offset<CompleteAuthenticationResponse> CreateCompleteAuthenticationResponse(::flatbuffers::FlatBufferBuilder &_fbb, const CompleteAuthenticationResponseT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _result_type = _o->result.type;
  auto _result = _o->result.Pack(_fbb);
  return fbs::CreateCompleteAuthenticationResponse(
      _fbb,
      _result_type,
      _result);
}
...
inline UploadUsageRequestT::UploadUsageRequestT(const UploadUsageRequestT &o)
      : history((o.history) ? new fbs::MachineUsageHistoryT(*o.history) : nullptr) {
}
...
inline void UploadUsageRequest::UnPackTo(UploadUsageRequestT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = history(); if (_e) { if(_o->history) { _e->UnPackTo(_o->history.get(), _resolver); } else { _o->history = std::unique_ptr<fbs::MachineUsageHistoryT>(_e->UnPack(_resolver)); } } else if (_o->history) { _o->history.reset(); } }
}
...
inline ::flatbuffers::Offset<UploadUsageRequest> CreateUploadUsageRequest(::flatbuffers::FlatBufferBuilder &_fbb, const UploadUsageRequestT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return fbs::CreateUploadUsageRequest(
      _fbb,
      _history);
}
...
inline ::flatbuffers::Offset<UploadUsageResponse> CreateUploadUsageResponse(::flatbuffers::FlatBufferBuilder &_fbb, const UploadUsageResponseT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return fbs::CreateUploadUsageResponse(
      _fbb,
      _success);
}
...
inline bool VerifyStartSessionResult(::flatbuffers::Verifier &verifier, const void *obj, StartSessionResult type) {
  switch (type) {
    ...
    case StartSessionResult::TokenSession: {
      auto ptr = reinterpret_cast<const fbs::TokenSession *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case StartSessionResult::AuthRequired: {
      auto ptr = reinterpret_cast<const fbs::AuthRequired *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case StartSessionResult::Rejected: {
      auto ptr = reinterpret_cast<const fbs::Rejected *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline ::flatbuffers::Offset<void> StartSessionResultUnion::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const ::flatbuffers::rehasher_function_t *_rehasher) const {
  ...
  switch (type) {
    case StartSessionResult::TokenSession: {
      auto ptr = reinterpret_cast<const fbs::TokenSessionT *>(value);
      return CreateTokenSession(_fbb, ptr, _rehasher).Union();
    }
    case StartSessionResult::AuthRequired: {
      auto ptr = reinterpret_cast<const fbs::AuthRequiredT *>(value);
      return CreateAuthRequired(_fbb, ptr, _rehasher).Union();
    }
    case StartSessionResult::Rejected: {
      auto ptr = reinterpret_cast<const fbs::RejectedT *>(value);
...
inline StartSessionResultUnion::StartSessionResultUnion(const StartSessionResultUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case StartSessionResult::TokenSession: {
      value = new fbs::TokenSessionT(*reinterpret_cast<fbs::TokenSessionT *>(u.value));
      break;
    }
    case StartSessionResult::AuthRequired: {
      value = new fbs::AuthRequiredT(*reinterpret_cast<fbs::AuthRequiredT *>(u.value));
      break;
    }
    case StartSessionResult::Rejected: {
      value = new fbs::RejectedT(*reinterpret_cast<fbs::RejectedT *>(u.value));
      break;
    }
    default:
      break;
...
inline void StartSessionResultUnion::Reset() {
  switch (type) {
    case StartSessionResult::TokenSession: {
      auto ptr = reinterpret_cast<fbs::TokenSessionT *>(value);
      delete ptr;
      break;
    }
    case StartSessionResult::AuthRequired: {
      auto ptr = reinterpret_cast<fbs::AuthRequiredT *>(value);
      delete ptr;
      break;
    }
    case StartSessionResult::Rejected: {
      auto ptr = reinterpret_cast<fbs::RejectedT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
#endif  // FLATBUFFERS_GENERATED_TOKENSESSION_FBS_H_
