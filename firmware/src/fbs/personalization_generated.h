...
#ifndef FLATBUFFERS_GENERATED_PERSONALIZATION_FBS_H_
#define FLATBUFFERS_GENERATED_PERSONALIZATION_FBS_H_
...
struct KeyDiversificationResponseT : public ::flatbuffers::NativeTable {
  ...
  std::unique_ptr<fbs::KeyBytes> application_key{};
  std::unique_ptr<fbs::KeyBytes> authorization_key{};
  std::unique_ptr<fbs::KeyBytes> reserved1_key{};
  std::unique_ptr<fbs::KeyBytes> reserved2_key{};
...
struct KeyDiversificationResponse FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const fbs::KeyBytes *application_key() const {
    return GetStruct<const fbs::KeyBytes *>(VT_APPLICATION_KEY);
  }
  const fbs::KeyBytes *authorization_key() const {
    return GetStruct<const fbs::KeyBytes *>(VT_AUTHORIZATION_KEY);
  }
  const fbs::KeyBytes *reserved1_key() const {
    return GetStruct<const fbs::KeyBytes *>(VT_RESERVED1_KEY);
  }
  const fbs::KeyBytes *reserved2_key() const {
    return GetStruct<const fbs::KeyBytes *>(VT_RESERVED2_KEY);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<fbs::KeyBytes>(verifier, VT_APPLICATION_KEY, 1) &&
           VerifyField<fbs::KeyBytes>(verifier, VT_AUTHORIZATION_KEY, 1) &&
           VerifyField<fbs::KeyBytes>(verifier, VT_RESERVED1_KEY, 1) &&
           VerifyField<fbs::KeyBytes>(verifier, VT_RESERVED2_KEY, 1) &&
           verifier.EndTable();
  }
...
struct KeyDiversificationResponseBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_application_key(const fbs::KeyBytes *application_key) {
    fbb_.AddStruct(KeyDiversificationResponse::VT_APPLICATION_KEY, application_key);
  }
  void add_authorization_key(const fbs::KeyBytes *authorization_key) {
    fbb_.AddStruct(KeyDiversificationResponse::VT_AUTHORIZATION_KEY, authorization_key);
  }
  void add_reserved1_key(const fbs::KeyBytes *reserved1_key) {
    fbb_.AddStruct(KeyDiversificationResponse::VT_RESERVED1_KEY, reserved1_key);
  }
  void add_reserved2_key(const fbs::KeyBytes *reserved2_key) {
...
inline ::flatbuffers::Offset<KeyDiversificationResponse> CreateKeyDiversificationResponse(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const fbs::KeyBytes *application_key = nullptr,
    const fbs::KeyBytes *authorization_key = nullptr,
    const fbs::KeyBytes *reserved1_key = nullptr,
    const fbs::KeyBytes *reserved2_key = nullptr) {
...
inline ::flatbuffers::Offset<KeyDiversificationRequest> CreateKeyDiversificationRequest(::flatbuffers::FlatBufferBuilder &_fbb, const KeyDiversificationRequestT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return fbs::CreateKeyDiversificationRequest(
      _fbb,
      _token_id);
}

inline KeyDiversificationResponseT::KeyDiversificationResponseT(const KeyDiversificationResponseT &o)
      : application_key((o.application_key) ? new fbs::KeyBytes(*o.application_key) : nullptr),
        authorization_key((o.authorization_key) ? new fbs::KeyBytes(*o.authorization_key) : nullptr),
        reserved1_key((o.reserved1_key) ? new fbs::KeyBytes(*o.reserved1_key) : nullptr),
        reserved2_key((o.reserved2_key) ? new fbs::KeyBytes(*o.reserved2_key) : nullptr) {
}
...
inline void KeyDiversificationResponse::UnPackTo(KeyDiversificationResponseT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = application_key(); if (_e) _o->application_key = std::unique_ptr<fbs::KeyBytes>(new fbs::KeyBytes(*_e)); }
  { auto _e = authorization_key(); if (_e) _o->authorization_key = std::unique_ptr<fbs::KeyBytes>(new fbs::KeyBytes(*_e)); }
  { auto _e = reserved1_key(); if (_e) _o->reserved1_key = std::unique_ptr<fbs::KeyBytes>(new fbs::KeyBytes(*_e)); }
  { auto _e = reserved2_key(); if (_e) _o->reserved2_key = std::unique_ptr<fbs::KeyBytes>(new fbs::KeyBytes(*_e)); }
}
...
inline ::flatbuffers::Offset<KeyDiversificationResponse> CreateKeyDiversificationResponse(::flatbuffers::FlatBufferBuilder &_fbb, const KeyDiversificationResponseT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return fbs::CreateKeyDiversificationResponse(
      _fbb,
      _application_key,
      _authorization_key,
      _reserved1_key,
...
#endif  // FLATBUFFERS_GENERATED_PERSONALIZATION_FBS_H_
