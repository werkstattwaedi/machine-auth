...
__attribute__((section(".psram.bss"))) std::byte channel_buffer[16384];
...
maco::display::DisplayDriver& GetDisplayDriver() {
  ...
  // See:
  // https://community.particle.io/t/photon-2-spi-dma-transfer-deadlock-take-2/70300/5
