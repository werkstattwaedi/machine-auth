 ...
 *  @endcode
 */
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(roboto_24) LV_FONT_DECLARE(roboto_12) LV_FONT_DECLARE(roboto_36) LV_FONT_DECLARE(material_symbols_24) LV_FONT_DECLARE(material_symbols_64)
