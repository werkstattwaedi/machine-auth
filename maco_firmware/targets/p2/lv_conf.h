/**
 * @file lv_conf.h
 * LVGL configuration for maco_firmware (Hardware)
...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    /* Place pool in PSRAM via linker section, keeping SRAM heap free for
       thread stacks. LVGL's built-in TLSF still manages the pool. */
