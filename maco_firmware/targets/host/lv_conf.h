/**
 * @file lv_conf.h
 * LVGL configuration for maco_firmware (Simulator)
 * Based on LVGL v9.4.0 template with project-specific customizations
 *
 ...
 *  @endcode
 */
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(roboto_24) LV_FONT_DECLARE(roboto_12) LV_FONT_DECLARE(roboto_16) LV_FONT_DECLARE(roboto_36) LV_FONT_DECLARE(material_symbols_24) LV_FONT_DECLARE(material_symbols_64)
...
/* TODO: Enable once SDL2 Bazel dependency is configured */
#define LV_USE_SDL              0
#if LV_USE_SDL
...
#define LV_USE_ST7789        1  /* Enabled for unit testing pico_res28_lcd driver */
